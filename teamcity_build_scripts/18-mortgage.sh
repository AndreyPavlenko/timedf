python3 run_ibis_tests.py --env_name ${ENV_NAME} --env_check True --save_env True --python_version 3.7 -task benchmark        \
                          ...
                          -db_server ${DATABASE_SERVER_NAME} -db_port 3306 -db_user ${DATABASE_USER_NAME} -db_pass omniscidb -db_name omniscidb -db_table_etl mortgage_etl -db_table_ml mortgage_ml
